...
def window_mainMenu():
    ...
    buttonFileUpload=Button(wndw_menu,text="Cargar Archivo",width=20,bg="#48F1D8", font=("Courier 15 bold"),relief="groove",bd=8)
    buttonFileUpload.place(x=220,y=120)

    buttonManageCourse=Button(wndw_menu,text="Gestionar Cursos",width=20,bg="#48F1D8", font=("Courier 15 bold"),relief="groove",bd=8)
    buttonManageCourse.place(x=220,y=180)

    buttonCreditCount=Button(wndw_menu,text="Conteo de Créditos",width=20,bg="#48F1D8", font=("Courier 15 bold"),relief="groove",bd=8)
    buttonCreditCount.place(x=220,y=240)

    buttonMainMenuOut=Button(wndw_menu,text="Salir",width=20,bg="#48F1D8", font=("Courier 15 bold"),relief="groove",bd=8)
...
def window_fileupload():
    ...
    buttonBackMainMenu=Button(wndw_fileupload,text="Regresar",width=11,bg="#C9A4F9", font=("Courier 13 bold"),relief="ridge",bd=8)
...
def window_managecourse():
    ...
    #Configuración Botones
    buttonListCourses=Button(wndw_managecourse,text="Listar Cursos",width=15,bg="#9EBCFF", font=("Courier 13 bold"),relief="ridge",bd=7)
    buttonListCourses.place(x=250,y=70)

    buttonAddCourse=Button(wndw_managecourse,text="Agregar Curso",width=15,bg="#9EBCFF", font=("Courier 13 bold"),relief="ridge",bd=7)
    buttonAddCourse.place(x=250,y=130)

    buttonEditCourse=Button(wndw_managecourse,text="Editar Curso",width=15,bg="#9EBCFF", font=("Courier 13 bold"),relief="ridge",bd=7)
    buttonEditCourse.place(x=250,y=190)

    buttonDeleteCourse=Button(wndw_managecourse,text="Eliminar Curso",width=15,bg="#9EBCFF", font=("Courier 13 bold"),relief="ridge",bd=7)
    buttonDeleteCourse.place(x=250,y=250)

    buttonBackmainmenu=Button(wndw_managecourse,text="Regresar",width=15,bg="#9EBCFF", font=("Courier 13 bold"),relief="ridge",bd=7)
...
def window_listcouse():
    ...
    #Configuración botones
    buttonBackManageCourse=Button(wndw_listcourse,text="Regresar",width=15,bg="#9EBCFF", font=("Courier 13 bold"),relief="ridge",bd=7)
...
def window_addcourse():
    ...
    #Configuración botones
    buttonBackManageCoursee=Button(wndw_addcourse,text="Regresar",width=12,bg="#C9A4F9", font=("Courier 13 bold"),relief="ridge",bd=7)
...
def window_editcourse():
    ...
    #Configuración botones
    buttonBackManageCoursse=Button(wndw_editcourse,text="Regresar",width=12,bg="#E99EFF", font=("Courier 13 bold"),relief="ridge",bd=7)
...
def window_deleteCourse():
    ...
    buttonBackManageCourssee=Button(wndw_deletecourse,text="Regresar",width=11,bg="#AFF5FF", font=("Courier 13 bold"),relief="ridge",bd=8)
...
def window_creditcount():
    ...
    #Configuración botones
    buttonBackManageCouurse=Button(wndw_credicount,text="Regresar",width=15,bg="#48F1D8", font=("Courier 13 bold"),relief="ridge",bd=7)
